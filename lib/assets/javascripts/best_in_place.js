...
BestInPlaceEditor.prototype = {
    ...
    update: function () {
        ...
        if (
            ...
            !confirm(this.warning_before_save)
              ...
              console.log("old value", this.oldValue.lastChild.innerHTML);
    ...
    initOptions: function () {
        ...
        self.warning_before_save = self.element.data("bipWarningBeforeSave") || self.warning_before_save;
        self.warning_before_save_with_new_values = self.element.data("bipWarningBeforeSaveWithNewValues") || self.warning_before_save_with_new_values;
